...
```
<<<<<<< HEAD
git remote add academy git@github.com:htmlacademy-react/1465455-what-to-watch-5.git
=======
git remote add academy git@github.com:htmlacademy-react/1465455-guess-melody-5.git
